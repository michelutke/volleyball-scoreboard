...
<body>
  <div class="container">
    ...
    <div class="body">
      ...
      <p style="font-size:13px;color:#4a5a7a;">Dieser Link ist ${linkExpirationFormatter(linkExpiration)?no_esc} gültig. Falls du diese E-Mail nicht erwartet hast, kannst du sie ignorieren.</p>
    </div>
    <div class="footer">
