...
<main class="mx-auto max-w-3xl px-4 py-24 md:px-8">
	<h1 class="mb-8 text-3xl font-bold text-[var(--color-text-primary)]">Datenschutzerklärung</h1>
	<p class="text-[var(--color-text-secondary)]">Datenschutzinformationen folgen.</p>
</main>
